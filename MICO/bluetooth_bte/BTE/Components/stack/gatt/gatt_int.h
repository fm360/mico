...
typedef struct
{
    ...
    /* GATT service change CCC related variable */
...
#define GATT_SERVICE_CHG_CCC_STAGE_4        4   /* service change CCC discoery */
...
extern void gatt_sr_send_req_callback(UINT16 conn_id,  UINT32 trans_id, UINT8 op_code, tGATTS_DATA *p_req_data);
...
extern tGATT_STATUS gatts_attibute_request (tGATT_CBACK *gatt_cback, UINT16 conn_id, UINT32 trans_id, tGATTS_REQ_TYPE type, tGATTS_DATA *p_data);
