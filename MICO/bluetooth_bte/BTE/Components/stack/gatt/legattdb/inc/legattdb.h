...
int legattdb_prepareWriteReq(UINT8 conn_idx, UINT8 *hdr, int pduValLen);

int legattdb_executeWriteReq(UINT8 flag);
...
int legattdb_dispatchWriteCb(LEGATTDB_ENTRY_HDR *p);
