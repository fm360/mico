...
#define BTM_128KBITS_RATE           0x00003E80  /* 128 kbits/sec data rate */
...
/* data type for BTM_SECURITY_UPGRADE_EVT */
typedef struct
{
    BD_ADDR         bd_addr;        /* peer address */
...
typedef struct
{
    ...
    BOOLEAN         privacy_supported;      /**< True if privacy supported, False if not    */
...
typedef enum {
    ...
    BTM_SECURITY_UPGRADE_EVT,               /**< Check if the application wants to upgrade the link key. Event data: tBTM_SP_UPGRADE */
...
typedef struct {
    BD_ADDR                         bd_addr;                                    /**< BD Address of remote */
    UINT8                           key_data[BTM_SECURITY_KEY_DATA_LEN];        /**< [in/out] Key data */
...
typedef union
{
    ...
    tBTM_SP_UPGRADE                     security_upgrade;                   /**< Data for BTM_SECURITY_UPGRADE_EVT */
