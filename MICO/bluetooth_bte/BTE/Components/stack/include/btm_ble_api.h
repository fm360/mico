...
**
*******************************************************************************/
BTM_API extern void BTM_BleConfirmReply (BD_ADDR bd_addr, UINT8 res);
...
**                  the local device.
**
** Parameters       privacy_mode:  privacy on or off
**
** Returns          BTM_SUCCESS privacy mode set success; otherwise failed.
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_BleConfigPrivacy(BOOLEAN privacy_mode);
