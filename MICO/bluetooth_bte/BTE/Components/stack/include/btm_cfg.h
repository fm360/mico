...
#define WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_MIN_INTERVAL    0x0006  /**< High duty cycle minimum connection event interval BTM_BLE_CONN_INT_MIN */
#define WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_MAX_INTERVAL    0x0C80  /**< High duty cycle maximum connection event interval BTM_BLE_CONN_INT_MAX */
...
#define WICED_BT_CFG_DEFAULT_LOW_DUTY_CONN_MIN_INTERVAL     0x0006  /**< Low duty cycle minimum connection event interval BTM_BLE_CONN_INT_MIN */
#define WICED_BT_CFG_DEFAULT_LOW_DUTY_CONN_MAX_INTERVAL     0x0C80  /**< Low duty cycle maximum connection event interval BTM_BLE_CONN_INT_MAX */
...
typedef struct
{
    ...
    uint16_t                            high_duty_conn_min_interval;    /**< High duty cycle minimum connection event interval (default: WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_MIN_INTERVAL) */
    uint16_t                            high_duty_conn_max_interval;    /**< High duty cycle maximum connection event interval (default: WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_MAX_INTERVAL) */
    ...
    uint16_t                            low_duty_conn_min_interval;     /**< Low duty cycle minimum connection event interval (default: WICED_BT_CFG_DEFAULT_LOW_DUTY_CONN_MIN_INTERVAL) */
    uint16_t                            low_duty_conn_max_interval;     /**< Low duty cycle maximum connection event interval (default: WICED_BT_CFG_DEFAULT_LOW_DUTY_CONN_MAX_INTERVAL) */
