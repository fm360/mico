...
{
    UINT16          conn_id;                /**< ID of the connection */
    INT32           trans_id;               /**< Transaction ID associated with this request and returned in the response */
...
**
*******************************************************************************/
GATT_API extern  tGATT_STATUS GATT_BLE_Connect (tGATT_IF gatt_if, BD_ADDR bd_addr,
...
**
*******************************************************************************/
GATT_API extern tGATT_STATUS GATT_BR_Connect (tGATT_IF gatt_if, BD_ADDR bd_addr);
