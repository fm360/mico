...
typedef struct
{
    ...
    tL2CAP_CFG_INFO         app_cfg;                /* App's desired configuration */
...
typedef struct
{
    ...
    UINT8                   fixed_reg_opts[L2CAP_NUM_FIXED_CHNLS];      /* Registration options (see L2CAP_REG_OPTS_*) */
...
****************************************
*/
extern void l2ble_process_peer_data (tL2C_LECB *p_lecb, BT_HDR *p_data);
