...
typedef struct
{
    ...
    bool    list_cmpl;      /**< Complete list or not */
 ...
 * @return
 */
typedef bool (wiced_bt_ble_selective_conn_cback_t)(wiced_bt_device_address_t remote_bda, uint8_t *p_remote_name);
 ...
 *
 */
int wiced_bt_start_advertisements(wiced_bt_ble_advert_mode_t advert_mode, wiced_bt_ble_address_type_t directed_advertisement_bdaddr_type, wiced_bt_device_address_ptr_t directed_advertisement_bdaddr_ptr);
 ...
 *
 */
int wiced_bt_ble_set_advertisement_data(wiced_bt_ble_advert_mask_t  data_mask,
 ...
 */
int  wiced_bt_ble_scan (wiced_bt_ble_scan_type_t scan_type, bool duplicate_filter_enable, wiced_bt_ble_scan_result_cback_t *p_scan_result_cback);
 ...
 *
 */
bool wiced_bt_ble_data_signature (wiced_bt_device_address_t bd_addr, uint8_t *p_text, uint16_t len,
 ...
 *
 */
bool wiced_bt_ble_verify_signature (wiced_bt_device_address_t bd_addr, uint8_t *p_orig,
 ...
 *
 */
bool wiced_bt_ble_set_background_connection_type (wiced_bt_ble_conn_type_t conn_type, wiced_bt_ble_selective_conn_cback_t *p_select_cback);
 ...
 *
 */
bool wiced_bt_ble_update_background_connection_device(bool add_remove, wiced_bt_device_address_t remote_bda);
 ...
 *
 */
void wiced_bt_ble_enable_privacy (bool enable);
 ...
 *
 */
void wiced_bt_ble_enable_mixed_privacy_mode(bool mixed_on);
 ...
 *
 */
bool wiced_bt_ble_get_security_state (wiced_bt_device_address_t bd_addr, uint8_t *p_le_sec_flags, uint8_t *p_le_key_size);
 ...
 *
 */
bool wiced_bt_ble_update_advertising_white_list(bool add, wiced_bt_device_address_t remote_bda);
 ...
 *  @return         void
 */
bool wiced_btm_ble_update_advertisement_filter_policy(wiced_bt_ble_advert_filter_policy_t advertising_policy);
