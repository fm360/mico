...
#define WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_MIN_INTERVAL    24      /**< High duty cycle minimum connection event interval BTM_BLE_CONN_INT_MIN */
#define WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_MAX_INTERVAL    40      /**< High duty cycle maximum connection event interval BTM_BLE_CONN_INT_MAX */
