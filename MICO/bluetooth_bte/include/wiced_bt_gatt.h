...
typedef struct
{
    ...
    bool    is_long;    /**< TRUE if long read */
...
{
    uint16_t      handle;     /**< Handle of attribute to read */
    bool  is_prep;    /**< TRUE if this is a prepare write request */
...
{
    uint16_t                                conn_id;            /**< ID of the connection */
    int32_t                                 trans_id;           /**< Transaction ID associated with this request and returned in the response */
 ...
 *
 */
wiced_bt_gatt_status_t wiced_bt_gatt_send_execute_write (uint16_t conn_id, bool is_execute);
 ...
 *
 */
bool wiced_bt_gatt_le_connect (wiced_bt_device_address_t bd_addr,
 ...
 *
 */
bool wiced_bt_gatt_bredr_connect (wiced_bt_device_address_t bd_addr);
 ...
 *
 */
bool wiced_bt_gatt_cancel_connect (wiced_bt_device_address_t bd_addr, bool is_direct);
 ...
 *
 */
bool wiced_bt_gatt_listen (bool start, wiced_bt_device_address_t bd_addr);
