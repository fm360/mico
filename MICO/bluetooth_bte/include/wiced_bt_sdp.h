 ...
 *
 **/
bool wiced_bt_sdp_db_init (uint8_t *p_sdp_db, uint16_t size);
 ...
 *
 **/
bool wiced_bt_sdp_init_discovery_db (wiced_bt_sdp_discovery_db_t *p_db, uint32_t len,
                                            uint16_t num_uuid,
 ...
 *
 **/
bool wiced_bt_sdp_cancel_service_search (wiced_bt_sdp_discovery_db_t *p_db);
 ...
 *
 **/
bool wiced_bt_sdp_service_search_request (uint8_t *p_bd_addr,
 ...
 *
 **/
bool wiced_bt_sdp_service_search_attribute_request (uint8_t *p_bd_addr,
                                                          wiced_bt_sdp_discovery_db_t *p_db,
                                                          wiced_bt_sdp_discovery_complete_cback_t *p_cb);
 ...
 *
 **/
bool wiced_bt_sdp_find_protocol_list_elem_in_rec (wiced_bt_sdp_discovery_record_t *p_rec,
                                                      uint16_t layer_uuid,
 ...
 *
 **/
bool wiced_bt_sdp_find_protocol_lists_elem_in_rec (wiced_bt_sdp_discovery_record_t *p_rec,
                                                       uint16_t layer_uuid,
                                                       wiced_bt_sdp_protocol_elem_t *p_elem);
 ...
 *
 **/
bool wiced_bt_sdp_find_profile_version_in_rec (wiced_bt_sdp_discovery_record_t *p_rec,
 ...
 *
 **/
bool wiced_bt_sdp_find_service_uuid_in_rec(wiced_bt_sdp_discovery_record_t *p_rec, wiced_bt_uuid_t *p_uuid);
