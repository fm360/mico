...
extern const platform_uart_config_t  bt_uart_config;
 ...
 */
wiced_bt_rfcomm_result_t wiced_bt_rfcomm_remove_connection (uint16_t handle, bool remove_server);
 ...
 *              <b> WICED_BT_RFCOMM_NOT_OPENED </b>     : If the connection is not opened
 */
wiced_bt_rfcomm_result_t wiced_bt_rfcomm_flow_control (uint16_t handle, bool enable);
