...
extern mico_semaphore_t	uart_rx_interrupt_sema;
...
__weak void log_service_init(void)
{
	int i;
...
void start_log_service(void)
{
	if(xTaskCreate(log_service, (char const*)"log_service", STACKSIZE, NULL, 5, NULL) != 0)
