...
//3 FW Loader Section
#define FW_LOADER_VALID_PATTEN_SECTION                   \
        SECTION(".fwloader.validate.rodata")
        
#define FW_LOADER_START_RAM_FUN_SECTION                   \
        SECTION(".fwloader.start_ram.data")

#define FW_LOADER_RAM_DATA_SECTION                   \
        SECTION(".fwloader.ram.data")

#define FW_LOADER_START_SECTION                   \
        SECTION(".fwloader.ram.start")
